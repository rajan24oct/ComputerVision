        ...
        * prediction_speed (optional); Acceptable values are "normal", "fast", "faster" and "fastest"
        ...
        if (self.__modelLoaded == False):
            ...
            if(self.__modelType == "" ):
                ...
                from com.ml.objects.Prediction.InceptionV3.inceptionv3 import preprocess_input, decode_predictions
    ...
    def predictImage(self, image_input, result_count=5, input_type="file" ):
        ...
        if (self.__modelLoaded == False):
            ...
            if (self.__modelType == "squeezenet"):
                ...
                from com.ml.objects.Prediction.InceptionV3.inceptionv3 import InceptionV3, preprocess_input, decode_predictions
        ...
        for image_input in sent_images_array:
            ...
            if (self.__modelLoaded == False):
                ...
                if (self.__modelType == "squeezenet"):
                    ...
                    from com.ml.objects.Prediction.InceptionV3.inceptionv3 import InceptionV3, preprocess_input, \
                        decode_predictions
